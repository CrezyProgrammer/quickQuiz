...
public class ReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity_quiz.btnClick(view, ReviewActivity.this);
            ...
            bookmark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (bookmark.getTag().equals("unmark")) {
                        ...
                        MainActivity_quiz.bookmarkDBHelper.insertIntoDB(review.getQueId(),
                                review.getQuestion(),
                                review.getRightAns(),
                                solution,
                                review.getImgUrl(),
                        ...
                        MainActivity_quiz.bookmarkDBHelper.delete_id(reviews.get(questionIndex).getQueId());
