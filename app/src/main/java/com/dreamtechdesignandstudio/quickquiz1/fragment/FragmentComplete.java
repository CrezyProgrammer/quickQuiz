...
import com.dreamtechdesignandstudio.quickquiz1.activity.ReviewActivity;
...
import static com.dreamtechdesignandstudio.quickquiz1.fragment.FragmentPlay.filter;
...
public class FragmentComplete extends Fragment implements android.view.View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     /*   interstitial = new InterstitialAd(getActivity());
        ...
        Log.i("123321","Total score for database "+totalScore);
        DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference("user").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("score");
        databaseReference.setValue(totalScore);
    ...
    public void PdfClicked() {
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&
            ...
            btnView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "quiz2/report.pdf");
