package com.dreamtechdesignandstudio.quickquiz1;

public class Constant {

    //////////////////////// POST API & PARAMETER  //////////////////////////

    public static String QUIZ_URL = "http://144.91.103.25/~quickqui/api-v2.php"; // admin page url
   // public static String QUIZ_URL = "http://10.0.2.2/api-v2.php"; // admin page url

    public static String DEVICE_REGISTRATION_API = "http://quickquizmobileapp.000webhostapp.com/api-v2.php/RegisterDevice.php";
